...
df_events.geo_location.fillna('', inplace=True)
...
# ad documents data
print('+ Loading promoted content...')

df_promoted = pd.read_csv("data/promoted_content.csv.zip")
...
def prepare_batch(batch):
    ...
    promoted_ad_str.reset_index(drop=1, inplace=True)
    display_str.reset_index(drop=1, inplace=True)
