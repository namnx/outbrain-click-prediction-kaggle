...
print('+ building the data for train...')
...
print('+ fitting the model for fold 0...')
C = 0.1
t0 = time()

svm_1 = LinearSVC(penalty='l1', dual=False, C=C, random_state=1)
svm_1.fit(X_0, y_0)
y_pred = svm_1.decision_function(X_1)
...
print('+ fitting the model for fold 1...')
t0 = time()

svm_0 = LinearSVC(penalty='l1', dual=False, C=C, random_state=1)
svm_0.fit(X_1, y_1)
y_pred = svm_0.decision_function(X_0)
...
pred_0 = svm_0.decision_function(X_test)
pred_1 = svm_1.decision_function(X_test)
